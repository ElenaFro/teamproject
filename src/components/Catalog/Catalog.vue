  ...
  methods: {
    ...
    filterPlants() {
      return this.PLANTS.filter((plant) => {
        let passCategory1 =
          this.filterOptions.category1 === "" ||
          plant.category1 === this.filterOptions.category1;
        let passCategory2 =
          this.filterOptions.category2 === "" ||
          plant.category2 === this.filterOptions.category2;
        let passAvailability =
          this.filterOptions.availability === "" ||
          plant.availability.toString() === this.filterOptions.availability;
        let passSale =
          !this.filterOptions.sale || plant.sale === this.filterOptions.sale;
